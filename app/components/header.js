...
var Header = React.createClass({
    ...
    isEditable(){
        if (this.state.loginUser && this.state.loginUser.id && this.state.loginUser.id === this.props.id) {
            return <div className="header-div-edit"><a className="nav-btn-right nav-btn-margin header-div-edit"
                                                       onClick={this.edit}>edit</a></div>
        }
    },
        ...
        return (
            <div>
                ...
                <div className="header-div-top">
                    ...
                    <Upload handleFileUrl={this.handleFileUrl} keys="bgImg"/>
